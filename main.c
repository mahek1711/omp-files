...
* Name: Mahek Delawala
* Student ID: 922968394
* GitHub Name:Mahek-Delawala
* Project: Assignment 4 Word Blast
*
* File: Delawala_Mahek_HW4_main.c
*
* Description: In This Assignment, we calulate the Frequency of
* Words with string length greater than or equal to six. Based
* on this We print down the top 10 words with Highest Count.
* Based on the Number of threads, we divide the file into
* equal parts and print the top 10 words with highest frequency.
*
*
**************************************************************/
